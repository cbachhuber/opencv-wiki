...
- Created an external page http://buildbot.itseez.com so that anybody can track opencv trunk status.  [Alexander]
...
Buildbot has been extended to measure function coverage (see buildbot.itseez.com, report from the "coverage" builder) [Alexander]
