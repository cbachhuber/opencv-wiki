...
* OpenVINO R2 and later comes with OpenCV built with DL IE support, so you can skip this step. Otherwise, or if you want to grab and build the latest OpenCV from source, build OpenCV as following:
