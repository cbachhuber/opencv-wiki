...
Feb 27, 16:00 UTC      | List of accepted mentoring organizations published             | [WE'RE IN!](https://summerofcode.withgoogle.com/organizations/5987197309157376/)
Feb 27 - Mar 20        | Potential student participants discuss application ideas with mentoring organizations | Send proposals to [GSoC site!](https://developers.google.com/open-source/gsoc/)
Mar 20, 16:00 UTC      | Student application period opens                               | Send proposals to [GSoC site!](https://developers.google.com/open-source/gsoc/)
...
1. **Karan Desai** - _"A Model Zoo for Tiny-dnn"_
    Mentors: Edgar Riba, Stefano Fabri, Taiga Nomi
2. **Laksono Kurnianggoro** - _"API for Facial Landmark Detector"_
    Mentors: Antonella Cascitelli, Delia Passalacqua
3. **Binbin Xu** - _"Computational Occlusion Removal in Image Inpainting"_
    Mentor: Gary Bradski
4. **Gang Song** - _"Create Web-based Interactive Tutorials and Examples for OpenCV"_
    Mentor: Sajjad Taheri
5. **João Cartucho** - _"Documentation Improvement w/code examples"_
    Mentor: Vincent Rabaud
6. **Suman Kumar Ghosh** - _"End to End text detection and recognition"_
    Mentor: Prasanna
7. **sukhad Anand** - _"Face alignment with opencv"_
    Mentor: StevenPuttemans
8. **Evgenii Zheltonozhskii** - _"GPU enabled deep learning framework"_
    Mentors: Edgar Riba, Stefano Fabri
9. **Mihai Bujanca** - _"Implementing and extending DynamicFusion (Newcombe et al 2015)"_
    Mentors: Reza Amayeh, Zhe Zhang
10. **Congxiang Pan** - _"Improve and Extend the JavaScript Bindings for OpenCV"_
    Mentor: Sajjad Taheri
11. **SHENGXIN QIAN** - _"Improve Background Subtraction with Aggregated Saliency"_
    Mentor: Antonella Cascitelli
12. **Vladislav Samsonov** - _"Improvement of the background subtraction algorithm"_
    Mentor: Maksim Shabunin
13. **kv** - _"Learning compact models for object detection"_
    Mentor: Vladimir Tyan
14. **Nan Yang** - _"Photometric Calibration"_
    Mentor: Grace Vesom
15. **Pau Rodríguez** - _"Recurrent Neural Networks on tiny-dnn"_
    Mentors: Edgar Riba, Taiga Nomi
16. **Jiri Horner** - _"Speeding-up AKAZE features"_
    Mentors: Bence Magyar, Vadim Pisarevsky, Vladimir Tyan
17. **Kuan Wang** - _"The Fast Bilateral Solver"_
    Mentor: Bo Li
