...
January 23 - February 11  | Google program administrators review organization applications  |:pray:
...
- QT functionality w/o the QT dependency; one option is to use OpenGL and draw various controls manually.
