...
** Announcing the "OpenCV Vision Challenge":http://code.opencv.org/projects/opencv/wiki/VisionChallenge
...
* "OpenCV Developer Site":http://code.opencv.org/projects/opencv/wiki
* "OpenCV User Site":http://opencv.org/
* "OpenCV Library Downloads":http://opencv.org/downloads.html
* "How to contribute to OpenCV":http://code.opencv.org/projects/opencv/wiki/How_to_contribute
