...
* Continuous integration. Android build is introduced into major OpenCV CI infrastructure http://buildbot.itseez.com. Set of unit-tests for Java API had been developed. Every night buildbot checkouts the latest code, builds it and runs a set of native and Java OpenCV tests.
