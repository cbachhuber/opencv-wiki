...
Template is at https://github.com/Itseez/opencv/wiki/Template
...
Buildbot (buildbot.itseez.com)
Added the Report page with full information about the current state of Buildbot, see http://argus-cv.dnsalias.org:8010/report

OSQA (alekcac.webfactional.com)
...
<pre>
Summary
2.4 beta has been delayed by 1 more week to make our buildbot (http://buildbot.itseez.com) "green", i.e. eliminate the remaining outstanding problems. The goal has been mostly achieved (>15 failures have been fixed); now the packages are being prepared and will be uploaded to SF this week.
...
** Change log  https://github.com/Itseez/opencv/wiki/ChangeLog
...
here is the changelog: https://github.com/Itseez/opencv/wiki/ChangeLog
...
* Release 2.4 is out!!! "2.4 Packages":https://github.com/Itseez/opencv/wiki/ChangeLog|Change log]], [[http://sourceforge.net/projects/opencvlibrary/files
...
Other than that, wiki has been partially converted to redmine format: meeting notes (https://github.com/Itseez/opencv/wiki/Meeting_notes), Changelog  (https://github.com/Itseez/opencv/wiki/ChangeLogHistory)
...
** "Change log Release 2.4.2":https://github.com/Itseez/opencv/wiki/ChangeLog
* GSoC
...
github.com/itseez/opencv admins to test each pull request using buildbot. In other words,
...
* Release candidate 2.4.3 is out https://github.com/Itseez/opencv/wiki/ChangeLog#243-rc
...
<pre>
[OpenCV 2.4.3rc]
The release candidate has been released. The changelog is here: https://github.com/Itseez/opencv/wiki/ChangeLog#243-rc
...
https://github.com/Itseez/opencv/tags. It's so minor that we will not make any public announce.
