...
<pre>
#ifndef _OPENCV_module_name_header_name_HPP_
#define _OPENCV_module_name_header_name_HPP_
#ifdef __cplusplus
...
* The code is put into cv or nested namespace (cv::vslam etc.). Test code is put into cvtest namespace.
