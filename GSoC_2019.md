...
=========================
### **>> IDEAS LIST UNDER CONSTRUCTION, JUST SOME HEADERS FOR NOW _JAN 15, 2019_ <<**
...
1. ### Improve circular fiducial calibration object detection

1. ### Logo and Picture to Fiducial

1. ### Add April Tags to OpenCV, with DNN detection
...
1. ### Better image & video encoding/decoding
