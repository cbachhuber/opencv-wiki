...
Each project a [GSoC compliant description](https://google.github.io/gsocguides/mentor/defining-a-project-ideas-list) on the Ideas list should include: 
   ...
   1. Difficulty rating (_easy, medium_ or _hard_) with optional description why
      * Use the [template](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#general-information)
...
### **All Projects Have These Universal Outcomes**
* You will comply with the [[OpenCV How to Contribute Guide|How_to_contribute].
      * You can use the [Aruco module in opencv_contrib](https://github.com/opencv/opencv_contrib/tree/master/modules/aruco) as an example.
...
1. ### <Template -- Replace with category such as "Deep Nets">
   1. #### <Descriptive Title>
