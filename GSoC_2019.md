...
Ideas are organized under an alphabetical list of Areas below each of which contain one to several project ideas.

[Circular Calibration](https://github.com/opencv/opencv/wiki/GSoC_2019#idea-calibration-patterns-using-circular-features), [Data Augmentation](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-computer-vision-data-augmentation-module), [GPU backend for DNN](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-allow-the-opencv-deep-neural-net-module-dnn-to-work-with-gpus), [Binary Neural Nets](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-enable-training-and-inference-with-binary-neural-networks), [Curated Deepnets](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-curate-additional-deep-neural-networks-for-the-dnn), [Point Coordinate Regression](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-point-coordinate-regression-and-dsac), [Differential Rendering](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-create-a-differentiable-rendering-module-torchgeometryrender), [Image Processing](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-differentiable-image-processing), [April Tags](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-add-april-tag-fiducial-detection-to-opencv), [Optical Flow](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-create-a-consolidated-optical-flow-module-optflow), [Python OpenCV](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-improve-and-expand-python-version-of-opencv), [Depth Fusion](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-kinectfusion-improvements), [Face Landmarks](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-facial-landmark-detector), [Boosted Cascades](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-a-universal-boosted-cascades-interface), [Machine Learning Tutorials](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-improve-machine-learning-tutorials-and-documentation), [GUI](https://github.com/opencv/opencv/wiki/GSoC_2019/_edit#idea-improve-the-opencv-user-interface)
...
* ### All Ideas Below
   1. #### Have these Additional Expected Outcomes:
      ...
      * Add unit tests, [see Aruco test example](https://github.com/opencv/opencv_contrib/tree/master/modules/aruco/test)
      * Add a tutorial, and sample code 
         * [see Aruco tutorials](https://github.com/opencv/opencv_contrib/tree/master/modules/aruco/tutorials) and how their [result looks on the web](https://docs.opencv.org/master/d9/d6d/tutorial_table_of_content_aruco.html).
...
1. ### Area: Deep Learning
   1. #### _IDEA:_ Allow the OpenCV Deep Neural Net Module (DNN) to work with GPUs
      ...
      * ***Skills Required:*** C++ mastery, Python and python interface tools for C++ code, GPU/Cuda working experience, coursework or professional work with Deep Nets, plus if you've optimized code before.
   ...
   1. #### _IDEA:_ Curate additional deep neural networks for the DNN 
      * ***Description:*** The [DNN module](https://docs.opencv.org/trunk/d6/d0f/group__dnn.html) in OpenCV allows for accomplishing powerful high end vision tasks with just a [few lines of code](https://www.pyimagesearch.com/2017/08/21/deep-learning-with-opencv/). The goal of this project is to currate more models for ease of use by the OpenCV DNN module.
      * ***Expected Outcomes:*** 
      ...
      * ***Skills Required:*** Skills Required: Coding in C++ and Python. Experience with deep neural networks.
