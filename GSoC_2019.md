...
* ### All Ideas Below
   1. #### Have these Additional Expected Outcomes:
      ...
      * Add a tutorial, [see Aruco tutorials](https://github.com/opencv/opencv_contrib/tree/master/modules/aruco/tutorials) and how their [result looks on the web](https://docs.opencv.org/master/d9/d6d/tutorial_table_of_content_aruco.html).
      * Add sample code (that can be used in the Tutorials). [See the Aruco samples](https://github.com/opencv/opencv_contrib/tree/master/modules/aruco/samples)
