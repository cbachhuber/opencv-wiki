...
1. ### Area: Tutorials
   ...
   1. #### Improve Machine Learning Tutorials and Documentation
...
1. ### Area: Geometric Vision
   1. #### Create a Consolidated Optical Flow Module "optflow"
...
1. ### Area: Programming Language
   1. #### Improve and Expand Python Version of OpenCV
      ...
      * ***Expected Outcomes:*** 
         ...
         1. Add tutorials for which Python code is already present. [ Link to python samples ](https://github.com/opencv/opencv/tree/master/samples/python)
