...
[**>>>   Skip directly to the opencv project ideas list below   <<<**](https://github.com/opencv/opencv/wiki/GSoC_2019#OpenCV-project-ideas-list)
...
- **Difficulty:** Easy to Medium depending on algorithms selected to create tutorials on
    - **Time:** Each topic takes about 2 weeks. One week to code examples, uses, record videos and another week to write it up. You can therefor do about 6 topics over the summer.
    - This topic is open to multiple students who will work independently on different tutorials

### 2. Deep Learning

### 3. Improve circular fiducial calibration object detection 

### 4. Logo and Picture to Fiducial

### 5. Add April Tags to OpenCV, with DNN detection
...
- [ OpenCV Ideas List](https://github.com/opencv/opencv/wiki/GSoC_2019#OpenCV-project-ideas-list)
...
5.  When (and if!) OpenCV gets accepted as GSoC org this year, and we are told how many slots we will get **and** you've signed up for a project with us, **Then:**
    ...
    - Accepted students will be posted on the GSoC site in May (and we will notify the accepted students ourselves afterwards).
