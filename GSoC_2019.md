...
Each project a [GSoC compliant description](https://google.github.io/gsocguides/mentor/defining-a-project-ideas-list) on the Ideas list should include: 
   1. Descriptive Title 
   1. Description of the project (2-5 sentences) 
   1. Expected outcomes
   1. Skills required/preferred 
   1. Possible mentors. 
   1. Difficulty rating (_easy, medium_ or _hard_) with optional description why
      * Use the [**template**](https://github.com/opencv/opencv/wiki/GSoC_2019/#template) below
...
1. ### Area: Tutorials
   ...
   1. #### _TITLE:_ Improve Machine Learning Tutorials and Documentation
...
1. ### Area: Differential operators
   1. #### _TITLE:_ Point Coordinate regression and DSAC.
...
https://github.com/anibali/dsntnn
   ...
   1. #### _TITLE:_ Create a differentiable rendering module “torchgeometry.render”
   ...
   1. #### _TITLE:_ Differentiable Image Processing
...
1. ### Area: Geometric Vision
   1. #### _TITLE:_ Create a Consolidated Optical Flow Module "optflow"
...
1. ### Area: Programming Language
   1. #### Improve and Expand Python Version of OpenCV
...
1. ### Area: Data Augmentation
   1. #### Computer vision data augmentation module
...
1. ### Area: Human Tracking and Segmentation
   1. #### _TITLE:_ Facial Landmark Detector
