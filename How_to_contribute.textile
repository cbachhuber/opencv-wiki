...
* Make sure that nobody beat you into fixing or reporting the issue by doing a search on the Github "OpenCV issues page":https://github.com/Itseez/opencv/issues, and making sure that there isn't someone working on it. In the latter case you might provide support or suggestion in the issue or in the linked pull request.
...
# Choose a task for youself. It could be a "bugfix":https://github.com/Itseez/opencv/issues, or some new code.
...
* Open up an issue at the "Github issues page":https://github.com/Itseez/opencv/issues/, so that people are aware of the problem and can support you in fixing it.
...
Please read "this":https://github.com/Itseez/opencv/wiki/How_to_contribute#The-instruction-in-brief, read the "Choose a base branch..." section.
