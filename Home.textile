...
Two git repositories are of main interest (developers will probably want both but opencv does not depend on opencv_contrib):
# "OpenCV":https://github.com/opencv/opencv The main library with highly used and low level supporting routines, structures etc.
# "opencv_contrib":https://github.com/opencv/opencv_contrib Newly contributed, often _state of the art_ functions.
